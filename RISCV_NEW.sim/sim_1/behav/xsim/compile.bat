...
REM
REM Generated by Vivado on Sun Jul 05 19:17:34 +0530 2026
...
echo "xvlog --incr --relax -prj tb_vector_datapath_vlog.prj"
call xvlog  --incr --relax -prj tb_vector_datapath_vlog.prj -log xvlog.log
